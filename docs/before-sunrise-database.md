...
3. **문장 스와이프용 한↔영 쌍 데이터에 비포 선라이즈는 없다.** 구글 시트
   기반 1,948쌍은 전부 디스인챈트먼트(1,117)와 비포 선셋(831). 비포
   선라이즈에서 비슷한 걸 하려면 chunks 443개(en·ko 쌍)를 활용하는 방법이 있음.
...
- **구문독해 탭**: 껍데기만 있음. 천일문식 커리큘럼(Part I 7무기 · Part II
  12전략)은 계획만 있고 데이터 미생성.
