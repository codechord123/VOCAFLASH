...
export const NIGHT_STOPS = [
  { cycle: 1, place: '기차 안', note: '낯선 사람에게 처음 말을 붙인다' },
  { cycle: 2, place: '트램과 다리', note: '비엔나에 내려 걷기 시작한다' },
  { cycle: 3, place: '레코드 가게', note: '청음실, 눈을 어디에 둘지 모르는' },
  { cycle: 4, place: '묘지와 골목', note: '죽음과 시간 이야기' },
  { cycle: 5, place: '프라터 관람차', note: '해 지는 관람차 위' },
  { cycle: 6, place: '카페', note: '전화 놀이 — 서로를 제3자로 말하기' },
  { cycle: 7, place: '밤거리와 시인', note: '즉흥시를 받아 드는 강가' },
  { cycle: 8, place: '성당과 강가', note: '밤이 깊어지고 말도 깊어진다' },
  { cycle: 9, place: '공원의 새벽', note: '와인과 잔디, 시간이 없다는 것' },
  { cycle: 10, place: '기차역, 해 뜨기 전', note: '헤어짐 — 그리고 약속' },
]
